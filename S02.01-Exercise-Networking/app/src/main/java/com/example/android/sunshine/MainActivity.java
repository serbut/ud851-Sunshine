...
public class MainActivity extends AppCompatActivity {
    ...
    public class GetWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                String json = NetworkUtils.getResponseFromHttpUrl(weatherUrl);
                return OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(getApplicationContext(), json);
